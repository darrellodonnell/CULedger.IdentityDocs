...
namespace CULedger.CS_DemoProject
{
    class Program
    {
        ...
        static string clientSecret = "<SECRET>";          // private key for Client
        static string tenantId = "<TENANTID>";          // UUID for TenantID (CULedger AD)
        static string endpointURL = "https://SUBDOMAIN.culedgerapi.com/CULedger/CULedger.Identity/0.3.0";            
